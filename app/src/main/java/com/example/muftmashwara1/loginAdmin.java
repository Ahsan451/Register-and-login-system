...
public class loginAdmin extends AppCompatActivity {
    ...
    String url  = "http://192.168.1.103/Myloginphp/logina.php";
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(username.getText().toString().equals("")){
                    Toast.makeText(loginAdmin.this, "Enter User Name", Toast.LENGTH_SHORT).show();

                }
                else if(pass.getText().toString().equals("")){
                    Toast.makeText(loginAdmin.this, "Enter Password", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    String myurl = "http://192.168.1.103/Myloginphp/logina.php?name="+ str_username + "&password=" + str_pass;
                    ...
                    StringRequest request = new StringRequest(Request.Method.POST, myurl, new Response.Listener<String>() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(loginAdmin.this, error.getMessage().toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(loginAdmin.this);
